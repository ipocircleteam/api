...
router.post("/create", auth_middleware_1.verifyAccessToken, middlewares_1.ValidateInputs, ipo_controller_1.createIpoEntry);
router.patch("/update", auth_middleware_1.verifyAccessToken, middlewares_1.ValidateInputs, ipo_controller_1.updateIpoEntry);
