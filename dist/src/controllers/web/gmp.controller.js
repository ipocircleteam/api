...
const getGmpData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        var resData;
        if (ipoId === undefined) {
            resData = yield db_2.myDataSource.getRepository(gmp_entity_1.default).find();
        }
        else {
            resData = yield db_2.myDataSource.getRepository(gmp_entity_1.default).findOne({
                where: {
                    ipo_id: ipoId,
                },
            });
...
const createIpoGMP = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const createGmp = yield db_2.myDataSource
        ...
        const saveGmp = yield db_2.myDataSource.getRepository(gmp_entity_1.default).save(createGmp);
        if (!saveGmp) {
...
const updateIpoGmp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateGmp = yield db_2.myDataSource.getRepository(gmp_entity_1.default).save(reqData);
        if (!updateGmp) {
