...
const getReviewData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        var resData;
        if (ipoId === undefined) {
            resData = yield db_1.myDataSource.getRepository(review_entity_1.default).find();
        }
        else {
            resData = yield db_1.myDataSource.getRepository(review_entity_1.default).findOne({
                where: {
                    ipo_id: ipoId,
                },
            });
...
const createIpoReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const saveReview = yield db_1.myDataSource.getRepository(review_entity_1.default).save(createReview);
        if (!saveReview) {
...
const updateIpoReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateReview = yield db_1.myDataSource.getRepository(review_entity_1.default).save(reqData);
        if (!updateReview) {
