...
const getCompanyFinanceData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        var resData;
        if (ipoId === undefined) {
            resData = yield db_1.myDataSource.getRepository(company_finance_entity_1.default).find();
        }
        else {
            resData = yield db_1.myDataSource
...
const createCompanyFinance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const createFinance = yield db_1.myDataSource
            .getRepository(company_finance_entity_1.default)
            .create(newFinance);
        if (!createFinance) {
            res
        ...
        const saveFinance = yield db_1.myDataSource
            .getRepository(company_finance_entity_1.default)
            .save(createFinance);
        if (!saveFinance) {
            res
...
const updateCompanyFinance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updateFinance = yield db_1.myDataSource
            .getRepository(company_finance_entity_1.default)
            .save(reqData);
        if (!updateFinance) {
            res
